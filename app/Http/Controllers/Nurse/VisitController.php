...
class VisitController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('nurse.visits.index', compact('visitsdata'));
    }
    ...
    public function create($appointment)
    {
        ...
        return view('nurse.visits.create', compact('createdata'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('nurse.visits.show', compact('visitdata'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $visitdata['visit'] = $visit;
        return view('nurse.visits.edit', compact('visitdata'));
    }
