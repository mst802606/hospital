...
<div class="container-fluid bg-light">
    <section>
        ...
        <div class="container-fluid mt-5">
            <a href="{{ route('patient.visits.index') }}" class="btn btn-warning m-2">View Upcoming</a>
        </div>
        <!--visit item-->
        <section>
        ...
        <section class=" m-5" id="visit-form">
            ...
            <div class="row tile">
                ...
                <form action="{{ route('patient.visits.update',['visit'=>$visit->id]) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="form-group">
                        ...
                        @enderror
                        <small id="patient_comment" class="d-none form-text text-muted">Well never share your visit patient comment with anyone else.</small>
                    </div>
