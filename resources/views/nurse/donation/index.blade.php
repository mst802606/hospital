...
<div class="container-fluid bg-light">
    <section>
        ...
        <div class="container-fluid mt-5">
            <a href="{{ route('doctor.donations.create') }}" class="btn btn-info m-2">Make a Donation</a>
                        ...
                        <table class="tile table table-bordered p-4 m-3 ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('doctor.donations.show',['donation'=>$donation->id]) }}"><i class="fa fa-eye"></i> View</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
