...
$doctors = $diagnosisdata['doctors'];
@endphp
<div class="container-fluid bg-light">
    <section>
        <!--diagnosis header-->
        <div class="container-fluid mt-5">
            <a href="{{ route('admin.diagnoses.index') }}" class="btn btn-warning m-2">View Upcoming</a>
        </div>
        <!--diagnosis item-->
        <section>
        ...
        <section class=" m-5" id="diagnosis-form">
            ...
            <div class="row tile">
                ...
                <form action="{{ route('admin.diagnoses.update',['diagnosis'=>$diagnosis->id]) }}" method="POST">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="diagnosis" id="diagnosis"
                            ...
                            placeholder="Enter doctors diagnosis here">{{ $diagnosis->diagnosis}}</textarea>
                        @error('diagnosis')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="prescription" id="prescription"
                            ...
                            placeholder="Enter doctors prescription here">{{ $diagnosis->prescription}}</textarea>
                        @error('prescription')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="regulation" id="regulation"
                            class="form-control @error('regulation') is-invalid @enderror"
                            placeholder="Enter doctors regulation here">{{ $diagnosis->regulation}}</textarea>
                        @error('regulation')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="message" id="message"
                            ...
                            placeholder="Enter doctors message here">{{ $diagnosis->message}}</textarea>
                        @error('message')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
