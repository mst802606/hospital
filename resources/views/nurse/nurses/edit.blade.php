				...
				<div class="container-fluid bg-light">
								<section>
												...
												<div class="container-fluid mt-5">
																<a href="{{ route('doctor.doctors.index') }}" class="btn btn-warning m-2">View All</a>
												</div>
												<!--doctor form-->
												<section class=" m-5" id="doctor-form">
																...
																<div class="row tile mt-3">
																				...
																				<form action="{{ route('doctor.doctors.update', ['doctor' => $doctor->id]) }}" method="POST">
																								@method('PUT')
																								@csrf
																								<!-- select user-->
																								...
																								<div class="form-group">
																												...
																												<a href="{{ route('doctor.doctors.register') }}" class="btn btn-info">Create a doctor
																																account</a>
																								</div>
																								...
																								<div class="form-group">
																												...
																												<select class="form-control form-control @error('available') is-invalid @enderror"
																																...
																																<option value="{{ $doctor->available }}" selected>
																																				@if ($doctor->available)
																																								Available
																																				@else
																																								Not Available
