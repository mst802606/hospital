...
@section('content')
				...
				<section class="login-content ">
								...
								<div class="register-box p-3 m-2">
												<!--user register form-->
												<form class="register-form" method="POST" action="{{ route('admin.doctors.register') }}"
																...
																<div class="form-outline mb-2 ">
																				<div class="row">
																								<div class="col-md-6 col-xl ">
																												<label class="form-label" for="firstname">Doctor first name</label>
																								...
																								<div class="col-md-6 col-xl">
																												<label class="form-label" for="lastname">Doctor Surname</label>
																...
																<div class="form-outline mb-2 d-none">
																				...
																				<input type="role" id="second-role"
																								...
																								value="2" required autocomplete="role" />
																				@error('role')
																								<span class="invalid-feedback" role="alert">
																												<strong>{{ $message }}</strong>
																								</span>
																...
																<div class="form-outline mb-2">
																				<div class="row">
																								<div class="col-xl col-md-6 col-sm">
																												<label class="form-label" for="phoneno">Doctor Phone Number</label>
																...
																<div class="form-outline mb-2">
																				<label class="form-label" for="password-confirm" minlength="8">Repeat Doctor password</label>
