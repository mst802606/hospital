																																								...
																																								<tr>
																																												...
																																												<td>
																																																@forelse ($visit->diagnosis as $diagnosis)
																																																				@if ($diagnosis->status)
																																																								<span
																																																												class="badge badge-success">{{ $diagnosis->created_at->format('d m y') }}
																																																												Processed </span>
																																																				@else
																																																								<span
																																																												class="badge badge-warning">{{ $diagnosis->created_at->format('d m y') }}
																																																												Pending </span>
																																																				@endif
																																																@empty
																																																				<a href="{{ route('doctor.diagnoses.create', ['visit' => $visit->id]) }}">
																																																								<span class="badge badge-info">No diagniosis made</span></a>
																																																@endforelse
