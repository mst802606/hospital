...
<div class="container-fluid bg-light">
    <section>
        ...
        <div class="container-fluid mt-5">
            <a href="{{ route('admin.appointments.create') }}" class="btn btn-info m-2">Create Appointment</a>
                        ...
                        <table class="tile table table-bordered p-4 m-3 ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.visits.create',['appointment'=>$appointment->id]) }}"><span
                                                class="badge badge-dark"><i class="fa fa-file"></i> Make
                                                Visit</span></a></td>
                                    <td><a
                                            href="{{ route('admin.appointments.show',['appointment'=>$appointment->id]) }}"><i
