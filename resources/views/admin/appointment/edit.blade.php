    ...
    <section>
        ...
        <section class=" m-5" id="appointment-form">
            ...
            <div class="row tile mt-3">
                ...
                <form action="{{ route('admin.appointments.update',['appointment'=>$appointment->id]) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <!-- select doctor-->
                    ...
                    <div class="form-group">
                        ...
                        <input name="title" type="title" class="form-control @error('title') is-invalid @enderror"
                            value="{{ $appointment->title }}" id="title" aria-describedby="title"
                    ...
                    <div class="form-group">
                        ...
                        <input name="purpose" type="purpose" value="{{ $appointment->purpose }}"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control form-control @error('patient_id') is-invalid @enderror"
                            ...
                            <option value="{{ $appointment->patient_id }}" selected>{{
                                $appointment->patient->user->username }}</option>
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <div class="flatpickr @error('date') is-invalid @enderror">
                                    <input name="date" value="{{ date('Y-m-d', strtotime($appointment->time))}}"
                                        type="date-local" class="form-control" placeholder="Select Date.." data-input>
                                    <!-- input is mandatory -->
                        ...
                        <div class="col-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="flatpickr  @error('time_hour') is-invalid @enderror">
                                    <input name="time_hour" type="time-local"
                                        value="{{date('H:i', strtotime($appointment->time)) }}" class="form-control"
