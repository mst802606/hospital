...
class DonationController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('admin.donation.index', compact('donationsdata'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.donation.create', compact('createdata'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('admin.donations.index'))->with('success', 'Donation appointment added successfully');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.donation.show', compact('donationdata'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $donation = Donation::where('id', $id)->first();
        $donationdata['donation'] = $donation;
        return view('admin.donation.edit', compact('donationdata'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect(route('admin.donations.show', ['donation' => $id]))->with('success', 'This item has been updated successfully');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect(route('admin.donations.index'))->with('success', 'This item has been deleted successfully');
    }
}
