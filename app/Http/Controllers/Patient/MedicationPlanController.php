...
class MedicationPlanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('patient.medication_plans.index', compact('plans'));
    }
    ...
    {
        return view('patient.medication_plans.create');
    }
    ...
    public function store(StoreMedicationPlanRequest $request)
    {
        ...
        return redirect()->route('patient.medication_plans.show', ['medication_plan' => $result->id])
    ...
    public function show(MedicationPlan $medicationPlan)
    {
        ...
        return view('patient.medication_plans.show', compact('plan', 'medications'));
    }
    ...
    public function edit(MedicationPlan $medicationPlan)
    {
        ...
        return view('patient.medication_plans.edit', compact('plan', 'medications'));
    }
    ...
    public function update(UpdateMedicationPlanRequest $request, MedicationPlan $medicationPlan)
    {
        ...
        // Redirect to the index page with a success message
        return redirect()->route('patient.medication_plans.show', ['medication_plan' => $medicationPlan->id])
    ...
    public function destroy(MedicationPlan $medicationPlan)
    {
        ...
        return redirect()->route('patient.medication_plans.index');
    }
}
