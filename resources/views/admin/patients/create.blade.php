...
@section('page')
				...
				<section class="login-content ">
								...
								<div class="register-box p-3 m-2">
												<!--user register form-->
												<form class="register-form" method="POST" action="{{ route('admin.patients.store') }}"
																...
																<div class="form-outline mb-2">
																				<label class="form-label" for="password-confirm" minlength="8">Repeat patients password</label>
