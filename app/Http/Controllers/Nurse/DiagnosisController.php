...
class DiagnosisController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('nurse.diagnosis.index', compact('diagnosesdata'));
    }
    ...
    public function create($visit)
    {
        ...
        return view('nurse.diagnosis.create', compact('createdata'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('nurse.diagnosis.show', compact('diagnosisdata'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $diagnosisdata['diagnosis'] = $diagnosis;
        return view('nurse.diagnosis.edit', compact('diagnosisdata'));
    }
