            ...
            <div class="row tile">
                ...
                <form action="{{ route('admin.donations.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="donor_message" class="form-control @error('donor_message') is-invalid @enderror"
                            value="{{ old('donor_message') }}" id="donor_message"
                            placeholder="Enter donor's message"></textarea>
                        @error('donor_message')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                        @enderror
                        <small id="message" class="form-text text-muted">Well never share your donations message with
                            anyone else.</small>
                    </div>
