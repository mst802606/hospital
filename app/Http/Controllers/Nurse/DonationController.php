...
class DonationController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('nurse.donation.index', compact('donationsdata'));
    }
    ...
    public function create()
    {
        ...
        return view('nurse.donation.create', compact('createdata'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('nurse.donation.show', compact('donationdata'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $donation = Donation::where('id', $id)->first();
        $donationdata['donation'] = $donation;
        return view('nurse.donation.edit', compact('donationdata'));
    }
