...
<body>
    <button class="open-button" onclick="openForm()"><i class="fa-sharp fa-solid fa-spinner fa-pulse"></i><i class="fa-solid fa-comments fa-3x"></i></button>

    <div class="chat-popup" id="myForm">
        <form action="{{ route('patient.messages.store') }}" class="form-container" method="POST">
            @csrf
