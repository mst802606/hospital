				...
				<div class="container-fluid message ">
								<div class="row">
												<div class="col col-md-6 col-xl ">
																...
																<hr />
																@forelse ($messagesdata['messages'] as $message)
																...
																@empty
																				<h4 role="alert"> No messages available</h4>
																				<div class="row">
																				...
																				<section class="message message-container overflow-auto" id="chat-section">
																								<div class="parent">
																												...
																												<div class="container">
																																...
																																<p><strong>Created by {{ $message->patient->user->username ?? 'Admin' }}</strong></p>
																																				...
																																				@if ($reply->key == 'doctor')
																																								<div class="container darker">
																																												<div class="col-md-3 col-xl-2"><img class="logo w-25"
																																																				...
																																																				style="width: 100%" /></div>
																																												<p><strong>{{ $reply->key ?? '' }}
																																																				{{ $message->doctor->user->username ?? 'Admin' }}</strong>
																																												</p>
																																												<p>{{ $reply->message }}</p>
																																												<span
																												...
																												<div class="child" id="reply-section">
																																<form action="{{ route('admin.messages.update', ['message' => $message->id]) }}"
																																				method="POST">
																																				@method('PUT') @csrf
																																				<label for="reply">
