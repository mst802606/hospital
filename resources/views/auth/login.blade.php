    ...
    <div class="login-box">
        ...
        <form class="login-form" method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group btn-container">
                <div class="col">
                    <button type="submit" class="btn btn-outline-dark btn-block"> SIGN IN <i class="fa fa-solid fa-right-to-bracket fa-lg fa-fw"></i>
                    </button>

                    <p class="semibold-text m-3"><a href="{{ route('register','role=1') }}">Or Register to be a member</a></p>
        ...
        <form class="forget-form" method="POST" action="{{ route('password.email') }}">
            ...
            <div class="form-group mt-3">
                <p class="semibold-text mb-0"><a href="/login" data-toggle="flip"><i class="fa fa-angle-left fa-fw"></i>
                        Back to Login</a></p>
            </div>
        </form>
    </div>
