...
class MedicationPlanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.medication_plans.index', compact('plans'));
    }
    ...
    {
        return view('admin.medication_plans.create');
    }
    ...
    public function show(MedicationPlan $medicationPlan)
    {
        ...
        return view('admin.medication_plans.show', compact('plan', 'medications'));
    }
