...
<div class="container-fluid bg-light">
    <section>
        ...
        <div class="container-fluid mt-5">
            <a href="{{ route('patient.visits.index') }}" class="btn btn-primary m-2">Back</a>
            <a href="{{ route('patient.visits.edit',['visit'=>$visit->id]) }}" class="btn btn-info m-2">Edit</a>
            <a onclick="document.getElementById('visit-delete-form').submit()" class="btn btn-danger m-2">Delete this item</a>
            <form id="visit-delete-form" action="{{ route('patient.visits.destroy',['visit'=>$visit->id]) }}" class="d-none" method="POST">
                @method("DELETE")
                @csrf
            </form>
        </div>
            ...
            <div class="container-fluid mt-4">
                ...
                <div class="col-md-6 col-xl-12 item">
                    <div class="row">
                        ...
                        @endif
                        <p class="rate">
                            Patient rating: @for ($i = 1; $i <$visit->patient_rating; $i++)<span class="rate-item fa fa-2x fa-star checked"></span> @endfor
                                @for ($i = $visit->patient_rating; $i <8; $i++)<span class="rate-item fa fa-2x fa-star"></span> @endfor
                        </p>
                        </tbody>
                        </table>
                    </div>
