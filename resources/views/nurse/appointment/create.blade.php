            ...
            <div class="row tile mt-3">
                ...
                <form action="{{ route('doctor.appointments.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input name="purpose" type="purpose" value="{{ old('purpose') }}" class="form-control @error('purpose') is-invalid @enderror" id="purpose" aria-describedby="purpose" placeholder="Enter purpose" required>
                        @error('purpose')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
