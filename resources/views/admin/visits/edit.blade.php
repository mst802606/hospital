    ...
    <section>
        ...
        <section class=" m-5" id="visit-form">
            ...
            <div class="row tile">
                ...
                <form action="{{ route('admin.visits.update',['visit'=>$visit->id]) }}" method="POST">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="doctor_comment" id="doctor_comment"
                            placeholder="Leave your comment here">{{ $visit->doctor_comment }}</textarea>
                        @error('doctor_comment')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                        @enderror
                        <small id="doctor_comment" class="d-none form-text text-muted">Well never share your visit
                            doctor comment with anyone else.</small>
                    </div>
                    <!--status-->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input name="patient_rating" type="patient_rating" value="{{ $visit->patient_rating }}"
                            class="form-control @error('patient_rating') is-invalid @enderror d-none" id="rating"
                            aria-describedby="patient_rating" placeholder="Enter patient_rating" required>
                        <p class="rate">
                        ...
                        @enderror
                        <small name="patient_rating" id="patient_rating" class="form-text text-muted">Well never share
                            your visit patient_rating with anyone else.</small>
                    </div>
                    <br>
