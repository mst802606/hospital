...
<div class="container-fluid bg-light">
    <section>
        ...
        <div class="container-fluid mt-5">
            <a href="{{ route('patient.appointments.create') }}" class="btn btn-info m-2">Create Appointment</a>
                        ...
                        <table class="tile table table-bordered p-4 m-3 ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('patient.appointments.show',['appointment'=>$appointment->id]) }}"><i class="fa fa-eye"></i> View</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
