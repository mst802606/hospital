...
class PatientMedicationAllocationController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('nurse.allocations.create', compact('patients', 'plans'));
    }
    public function store(Request $request)
    {
        ...
        return redirect()->route('nurse.medication_plans.index')->with('success', 'Medication plan successfully allocated to the patient.');
